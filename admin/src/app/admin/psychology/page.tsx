...
// 模拟心理专题文章数据
const mockPsychologyArticles = [
  {
    id: '1',
    title: '认知偏差在决策中的影响',
    description: '探讨各种认知偏差如何影响我们的日常决策过程',
    status: 'published',
    author: '心理学研究团队',
    publishedAt: '2025-01-30',
    tags: ['认知心理学', '决策科学', '行为经济学'],
    views: 1850,
  },
  {
    id: '2',
    title: '情绪调节的神经科学机制',
    description: '从神经科学角度分析情绪调节的大脑机制',
    status: 'draft',
    author: '心理学研究团队',
    publishedAt: null,
    tags: ['神经科学', '情绪心理学', '大脑研究'],
    views: 0,
  },
  {
    id: '3',
    title: '社交媒体对心理健康的影响',
    description: '分析社交媒体使用与心理健康之间的复杂关系',
    status: 'published',
    author: '心理学研究团队',
    publishedAt: '2025-01-27',
    tags: ['社会心理学', '数字心理学', '心理健康'],
    views: 2200,
  },
];

export default function PsychologyArticlesPage() {
  const [articles, setArticles] = useState(mockPsychologyArticles);
  ...
  // 加载心理专题文章
  useEffect(() => {
    loadPsychologyArticles();
  }, [statusFilter]);

  const loadPsychologyArticles = async () => {
    try {
      setLoading(true);
      const params = new URLSearchParams();
      params.append('category', 'psychology');
    ...
    <AdminLayout>
      <div className="content-area py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="page-title">心理专题</h1>
            <p className="page-subtitle">管理心理学研究相关的文章内容</p>
          </div>
          ...
          <CardContent className="p-0">
                      ...
                      <td className="table-cell">
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            size="sm"
                            icon={<EyeIcon />}
                            onClick={() => window.open(`https://nssa.io/psychology/${article.id}`, '_blank')}
                          />
                          <Button
                            variant="ghost"
                            size="sm"
            ...
            {filteredArticles.length === 0 && (
              <div className="empty-state">
                ...
                <h3 className="empty-state-title">暂无心理学文章</h3>
                <p className="empty-state-description">
                  {searchQuery ? '没有找到匹配的文章' : '还没有创建任何心理学文章'}
                </p>
                <Button
                  variant="primary"
                  icon={<PlusIcon />}
